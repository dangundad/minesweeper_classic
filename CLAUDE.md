...
- 난이도: ★★☆
- 광고 등급: 상
- 프로젝트 폴더: `minesweeper_classic`
- `pubspec` 이름: `minesweeper_classic`
- Android 패키지: `com.dangundad.minesweeper`
- 버전: `1.0.0+1`
- 핵심 기능: 9x9/16x16/30x16 그리드, 깃발 표시, 첫 클릭 안전, 타이머
...
## 빠른 명령어
```bash
cd C:\Flutter_WorkSpace\minesweeper_classic
flutter pub get
...
- `data/models`: 없음
- `data/enums`: `difficulty.dart`, `game_status.dart`
- `data/constants`: 없음
- `data` 루트 파일: 없음
