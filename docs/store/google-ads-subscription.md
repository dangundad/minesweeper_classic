# 구글 플레이 콘솔 광고/결제 설정 가이드 (Minesweeper Classic)
...
| --- | --- | --- |
| 배너 광고 | 적용됨 | 홈 화면 하단 |
| 전면 광고 | 코드 준비됨 | 게임 클리어(승리) 시 노출 |
| 보상형 광고 | 코드 준비됨 | 패배 다이얼로그 "Watch Ad" → Extra Life 획득 |
...
- 추후 옵션: 광고 제거 평생권, Extra Life 팩 구매 검토 가능
