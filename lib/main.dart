...
// ================================================
// MinesweeperClassic, minesweeper_classic 치환 후 사용
// mbti_pro 프로덕션 패턴 기반
...
Future<void> main() async {
  ...
  runApp(const MinesweeperClassicApp());
}

class MinesweeperClassicApp extends StatelessWidget {
  const MinesweeperClassicApp({super.key});
